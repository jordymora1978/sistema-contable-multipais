        ...
        if drapify_file:
            try:
                with st.spinner("Procesando archivos... Esto puede tardar unos segundos."):
                    ...
                    st.write("DEBUG: Ejemplos de order_id en DRAPIFY:", df_processed['order_id'].head().tolist())
                    ...
                    if cxp_file:
                        try:
                            ...
                            if df_cxp is not None:
                                ...
                                st.write("DEBUG: Ejemplos de asignacion_cxp en CXP:", df_cxp['asignacion_cxp'].head().tolist())
